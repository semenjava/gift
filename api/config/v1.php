...
return		[
                ...
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'GET get-receiver-user/{id_users}' => 'get-receiver-user',
                        'GET get-list/{id_users}/{limit}/{offset}' => 'get-list',
                        'POST create' => 'create',
                        'PUT update/{id}' => 'update',
                    ],
                ],
